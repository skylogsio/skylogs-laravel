...
import type { IAlertRule, IGeneralAlertHistoryInstance } from "@/@types/alertRule";
...
export default function PrometheusFiredInstance({ alertId }: { alertId: IAlertRule["id"] }) {
  ...
  const [details, setDetails] = useState<IGeneralAlertHistoryInstance | null>(null);
  ...
  return (
    <>
      <DataTable<IGeneralAlertHistoryInstance>
        data={data}
